...
**Prerequisites:** WSL (Ubuntu), Python 3.10+, Node 20+
...
First run installs Python deps + Node deps and downloads the BGE embedding model (~130MB) — allow ~7 minutes. Every subsequent run boots in under 10 seconds.
